...
export const setUserData = (user) => async (dispatch, getState) => {
  ...
  */
  ...
  if (settingsConfig.loginRedirectUrl === '/logout') {
    settingsConfig.loginRedirectUrl = '/tasks'; // deixa o redirect para a página Login
  }
  ...
  */
  ...
  dispatch(
    setUser({
      ...
      shortcuts: 'shortcuts',
      data: {
        displayName: jwtDecode(user).payload.userName,
        photoURL: `https://robohash.org/${jwtDecode(user).payload.userName}`,
        email: '',
      },
      role: ['user'],
    })
